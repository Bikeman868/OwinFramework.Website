        ...
        public SiteMap Initialize()
        {
            ...
            Projects = new[]
            {
                ...
                new Project("OwinFramework.Pages.Html", "OwinFramework.Pages", "pages", 
                    ...
                    .AddTopic(new Topic("Page attributes", "Page attributes", null)
                    ...
                    .AddTopic(new Topic("Layout attributes", "Layout attributes", null)
                    ...
                    .AddTopic(new Topic("Region attributes", "Region attributes", null)
