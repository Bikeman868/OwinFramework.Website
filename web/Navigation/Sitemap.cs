        ...
        public SiteMap Initialize()
        {
            ...
            Projects = new[]
            {
                ...
                new Project("OwinFramework.Pages.Html", "OwinFramework.Pages", "pages", 
                    ...
                    .AddTopic(new Topic("General attributes", "Html framework attributes", null)
                        ...
                        .AddTopic(new Topic("PartOf", "The [PartOf] attribute", "/content/project/owinframework.pages.html/attributes/partof"))
                        .AddTopic(new Topic("RenderHtml", "The [RenderHtml] attribute", "/content/project/owinframework.pages.html/attributes/renderhtml"))
                        .AddTopic(new Topic("RenderTemplate", "The [RenderTemplate] attribute", "/content/project/owinframework.pages.html/attributes/rendertemplate"))
                        .AddTopic(new Topic("Style", "The [Style] attribute", "/content/project/owinframework.pages.html/attributes/style"))
                        .AddTopic(new Topic("SuppliesData", "The [SuppliesData] attribute", "/content/project/owinframework.pages.html/attributes/suppliesdata"))
                        .AddTopic(new Topic("UsesComponent", "The [UsesComponent] attribute", "/content/project/owinframework.pages.html/attributes/usescomponent"))
                        .AddTopic(new Topic("UsesLayout", "The [UsesLayout] attribute", "/content/project/owinframework.pages.html/attributes/useslayout")) )
                    .AddTopic(new Topic("Page only attributes", "Page attributes", null)
                        .AddTopic(new Topic("CacheOutput", "The [CacheOutput] attribute", "/content/project/owinframework.pages.html/attributes/cacheoutput"))
                        .AddTopic(new Topic("PageTitle", "The [PageTitle] attribute", "/content/project/owinframework.pages.html/attributes/pagetitle"))
                        ...
                        .AddTopic(new Topic("Route", "The [Route] attribute", "/content/project/owinframework.pages.html/attributes/route")) )
                    .AddTopic(new Topic("Layout only attributes", "Layout attributes", null)
                        .AddTopic(new Topic("ZoneComponent", "The [ZoneComponent] attribute", "/content/project/owinframework.pages.html/attributes/zonecomponent"))
                        .AddTopic(new Topic("ZoneHtml", "The [ZoneHtml] attribute", "/content/project/owinframework.pages.html/attributes/zonehtml"))
                        .AddTopic(new Topic("ZoneLayout", "The [ZoneLayout] attribute", "/content/project/owinframework.pages.html/attributes/zonelayout"))
                        .AddTopic(new Topic("ZoneRegion", "The [ZoneRegion] attribute", "/content/project/owinframework.pages.html/attributes/zoneregion"))
                    ...
                    .AddTopic(new Topic("Region only attributes", "Region attributes", null)
                        .AddTopic(new Topic("DataScope", "The [DataScope] attribute", "/content/project/owinframework.pages.html/attributes/datascope"))
                        .AddTopic(new Topic("Repeat", "The [Repeat] attribute", "/content/project/owinframework.pages.html/attributes/repeat")) )
